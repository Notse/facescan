...
class App extends Component {
  ...
  componentDidMount() {
    fetch('https://ancient-fjord-01096.herokuapp.com/')
    .then(resp => resp.json())
  }
  ...
  return (
    <div className="App">
       ...
       <Navigation signedIn={this.state.signedIn} outScreen={this.homeScreen}/>
       { this.state.route === "home"
       ? <div>
          <Logo />
          <Rank name={this.state.user.name}  entries={this.state.user.entries}/>
          <InputForm onButtonClick={this.onButtonClick} onChangeInput={this.onChangeInput} /> 
